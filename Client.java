...
//for only client(ping sites):
    ...
    //IP / port:
        //208.67.220.220 / 443
        //vk.com / 443, 33434
        //youtube.com / 443, 33434
//Functions:
    //sendPackageFromFileToServer() - отправляет пакеты, считывая с указанного файла
    //sendPackageToServer() - отправляет пакеты, указанные в массиве sendData
package org.example;
